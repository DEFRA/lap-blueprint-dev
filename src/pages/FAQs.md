...
[How to access default tools and license](../../new-layout/delivery-processes/access-license/) explains how to get a GitHub Copilot licence and access approved AI tools. You can then check [AICE AI Toolkit Links](../../new-layout/standards-patterns-and-templates/Standards/ai-tooling-standards/) for approved tooling and practical references.
...
Follow [How to add your LAP AI Agent to our LAMAI's AI Directory](../../new-layout/ai-catalogue/ai-directory-contribution/) and browse the [AI Directory](../../new-layout/ai-catalogue/ai-directory/) for existing definitions.
